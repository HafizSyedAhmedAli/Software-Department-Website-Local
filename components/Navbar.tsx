      ...
      >
          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link href="/" className="flex items-center gap-3 shrink-0">
              ...
              <div className="hidden sm:block">
                <p className="font-display text-navy-950 font-bold text-base leading-tight">
                  Software Engineering
                </p>
                <p className="font-body text-xs text-slate-500 leading-tight">
                  QUEST Nawabshah
                </p>
              </div>
            </Link>
        ...
        >
          ...
          <div className="bg-navy-950 px-4 py-3 flex flex-col gap-2">
            <a href={`mailto:${CONTACT.email}`} className="text-xs text-slate-300 flex items-center gap-2">
              <Mail size={11} /> {CONTACT.email}
            </a>
            <a href={`tel:${CONTACT.phone}`} className="text-xs text-slate-300 flex items-center gap-2">
