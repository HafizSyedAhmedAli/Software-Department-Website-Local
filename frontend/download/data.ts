...
export const COURSES_DATA: OBE_Course[] = [
  // Intentionally empty — all courses now live in the CMS (Sanity Studio).
  // The old placeholder courses were removed so they can no longer appear
  // alongside or duplicate the real CMS-entered courses on the website.
];