...
export const metadata: Metadata = {
  ...
  description:
    "The Program Educational Objectives of the Software Engineering Department at QUEST Nawabshah.",
};
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="font-body text-slate-500 leading-relaxed mb-12 max-w-3xl">
            ...
            programme is preparing graduates to achieve. They are aligned with
            the mission of the department and the needs of stakeholders.
          </p>
          ...
          <div className="mt-12 bg-navy-50 border border-navy-100 rounded-sm p-5">
            <p className="font-body text-sm text-navy-800 leading-relaxed">
              <strong className="text-navy-950">Note:</strong> These Program
              Educational Objectives have been developed in consultation with
              industry partners, alumni, and faculty, and are reviewed
              periodically as part of the Continuous Quality Improvement (CQI)
              process.
            </p>
          </div>
        </div>
