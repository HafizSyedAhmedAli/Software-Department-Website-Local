...
export const metadata: Metadata = {
  title: "Events",
  description:
    "Latest news, events, and announcements from the Software Engineering Department at QUEST Nawabshah.",
};
...
export default function EventsPage() {
  ...
  return (
    <>
      <PageHeader
        title="News & Events"
        subtitle="Stay up to date with the latest happenings, achievements, and announcements from our department."
        crumbs={[{ label: "Events" }]}
      />
